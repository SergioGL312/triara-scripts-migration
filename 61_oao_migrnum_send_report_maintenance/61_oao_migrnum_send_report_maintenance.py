...
report_path = f"/backup-report/reports/rnum/rnum-maintenance-exadata-{start_date}.csv"

subject_base = f"RNUM - Migración OCI Región 2 - Reporte de mantenimientos al Exadata ({start_date} a {end_date})"
